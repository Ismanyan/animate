        ...
        <div class="row">
            <div class="footer-top pb_60 mb_30">
                <div class="col-xs-12 col-sm-6">
                    <div class="footer-logo"> <a href="index.html"> <img src="<?= asset_url() ?>images/logo.png" alt="Animate" width="150"> </a> </div>
                    ...
                    <div class="Testimonial">
                        <div class="client owl-carousel">
                            <div class="item client-detail">
                                <div class="client-avatar"> <img alt="" src="<?= asset_url() ?>images/user1.jpg"> </div>
                            ...
                            <div class="item client-detail">
                                <div class="client-avatar"> <img alt="" src="<?= asset_url() ?>images/user2.jpg"> </div>
                                <div class="client-title"><strong>joseph Lui</strong></div>
                                <div class="client-designation mb_10"> - php Developer</div>
                                <p><i class="fa fa-quote-left" aria-hidden="true"></i>Lorem ipsum dolor sit amet, volumus oporteat his at sea in Rem ipsum dolor sit amet, sea in odio ..</p>
                            </div>
                            <div class="item client-detail">
                                <div class="client-avatar"> <img alt="" src="<?= asset_url() ?>images/user3.jpg"> </div>
                                <div class="client-title"><strong>joseph Lui</strong></div>
                                <div class="client-designation mb_10"> - php Developer</div>
                                <p><i class="fa fa-quote-left" aria-hidden="true"></i>Lorem ipsum dolor sit amet, volumus oporteat his at sea in Rem ipsum dolor sit amet, sea in odio ..</p>
                            </div>
...
<a id="scrollup"></a>
<script src="<?= asset_url() ?>js/jQuery_v3.1.1.min.js"></script>
<script src="<?= asset_url() ?>js/owl.carousel.min.js"></script>
<script src="<?= asset_url() ?>js/bootstrap.min.js"></script>
<script src="<?= asset_url() ?>js/jquery.magnific-popup.js"></script>
<script src="<?= asset_url() ?>js/jquery.firstVisitPopup.js"></script>
